...
// ----------------------------------------------------------------------
export default function NCCListToolbar({
  selected,
  filterName,
  onFilterName,
  setLoad,
  ...
  const deleteUser = async () => {
    try {
      const res = await deleteData(API_BASE_URL + '/nhacungcap/delete', {
      ...
      >
        {numSelected > 0 ? (
          ...
          <SearchStyle
            ...
            placeholder="Tìm kiếm chủ sở hữu đất..."
            startAdornment={
