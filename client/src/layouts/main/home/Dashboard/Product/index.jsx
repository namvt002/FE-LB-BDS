        ...
        <div className="product-box product-item-main product-item-compare">
            <div className="product-thumbnail" >
                <Link className="image_thumb p_img" to={`/san-pham/${props.product?.sp_id}`} title={props.product.sp_ten}>	
                    <img style={{width: "800px", height: "250px"}} src={ props?.product ? 'http://192.168.1.5:4000/public/'+ props?.product?.sp_hinhanh[0]?.ha_hinh : ''} alt="Cho thuê căn hộ, biệt thự cao cấp"/>
                </Link>
